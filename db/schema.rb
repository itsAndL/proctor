...
ActiveRecord::Schema[7.2].define(version: 20_241_008_094_822) do
  ...
  create_table 'custom_question_responses', force: :cascade do |t|
    ...
    t.index %w[assessment_participation_id custom_question_id], name: 'index_custom_question_responses_uniqueness', unique: true
  ...
  create_table 'options', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[optionable_type optionable_id], name: 'index_options_on_optionable'
  end
  ...
  create_table 'participation_tests', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[assessment_participation_id test_id], name: 'index_participation_tests_on_assessment_participation_and_test', unique: true
  ...
  create_table 'question_answers', force: :cascade do |t|
    ...
    t.index %w[assessment_participation_id test_question_id], name: 'index_question_answers_on_participation_and_test_question', unique: true
